...
<root>
  ...
  ├── Editor
  │   ├── Haivd.ZitgaPackageManager.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Haivd.ZitgaPackageManager.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Haivd.ZitgaPackageManager.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Haivd.ZitgaPackageManager.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Haivd.ZitgaPackageManager`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Zitga Package Manager Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Haivd.ZitgaPackageManager.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Haivd.ZitgaPackageManager.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Haivd.ZitgaPackageManager.Editor.Tests.asmdef`

  `Tests/Runtime/Haivd.ZitgaPackageManager.Tests.asmdef`
...
Use the `Documentations~/Zitga Package Manager.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
