...
<root>
  ...
  ├── Editor
  │   ├── Zitga.TrackingFirebase.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Zitga.TrackingFirebase.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Zitga.TrackingFirebase.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Zitga.TrackingFirebase.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Zitga.TrackingFirebase`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Tracking Firebase Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Zitga.TrackingFirebase.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Zitga.TrackingFirebase.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Zitga.TrackingFirebase.Editor.Tests.asmdef`

  `Tests/Runtime/Zitga.TrackingFirebase.Tests.asmdef`
...
Use the `Documentations~/Tracking Firebase.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
