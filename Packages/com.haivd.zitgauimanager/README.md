...
<root>
  ...
  ├── Editor
  │   ├── Haivd.ZitgaUiManager.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Haivd.ZitgaUiManager.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Haivd.ZitgaUiManager.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Haivd.ZitgaUiManager.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Haivd.ZitgaUiManager`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Zitga UI Manager Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Haivd.ZitgaUiManager.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Haivd.ZitgaUiManager.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Haivd.ZitgaUiManager.Editor.Tests.asmdef`

  `Tests/Runtime/Haivd.ZitgaUiManager.Tests.asmdef`
...
Use the `Documentations~/Zitga UI Manager.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
