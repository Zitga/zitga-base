...
namespace deVoid.UIFramework.Editor
{
    public static class UIFrameworkTools
    {
        ...
        private static GameObject CreateUIFrameLandscape()
        {
            if (GameObject.FindObjectOfType<UIFrame>())
            {
                throw new System.Exception("Exist UIFrame on the screen");
            }
        ...
        private static GameObject CreateUIFramePortrait()
        {
            var root = CreateUIFrameLandscape();
