...
<root>
  ...
  ├── Editor
  │   ├── Haivd.CasualUiManager.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Haivd.CasualUiManager.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Haivd.CasualUiManager.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Haivd.CasualUiManager.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Haivd.CasualUiManager`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Casual UI Manager Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Haivd.CasualUiManager.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Haivd.CasualUiManager.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Haivd.CasualUiManager.Editor.Tests.asmdef`

  `Tests/Runtime/Haivd.CasualUiManager.Tests.asmdef`
...
Use the `Documentations~/Casual UI Manager.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
