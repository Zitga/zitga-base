...
<root>
  ...
  ├── Editor
  │   ├── Zitga.UiSystem.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Zitga.UiSystem.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Zitga.UiSystem.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Zitga.UiSystem.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Zitga.UiSystem`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package UI System Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Zitga.UiSystem.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Zitga.UiSystem.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Zitga.UiSystem.Editor.Tests.asmdef`

  `Tests/Runtime/Zitga.UiSystem.Tests.asmdef`
...
Use the `Documentations~/UI System.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
